...
export const devopsDebugAgent: AgentDefinition = {
  ...
  allowedTools: ['read_file', 'list_dir', 'grep_search', 'execute_command', 'introspect_doctype', 'list_customizations', 'ask_clarification', 'update_todo_list', 'use_skill', 'call_mcp_tool'],
  highRiskTools: ['execute_command', 'call_mcp_tool'],
