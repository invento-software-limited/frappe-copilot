...
- For scaffolding a new app or DocType, prefer 'scaffold_app'/'scaffold_doctype' over hand-building the equivalent 'bench new-app'/'bench new-doctype' invocation yourself via execute_command — they already handle the non-interactive answer sequence and, for scaffold_app, verify the result landed on disk.`,
};
