...
export const clientUiAgent: AgentDefinition = {
  ...
  allowedTools: ['read_file', 'write_file', 'edit_file', 'list_dir', 'grep_search', 'introspect_doctype', 'list_customizations', 'write_client_script', 'ask_clarification', 'update_todo_list', 'use_skill'],
  highRiskTools: ['write_file', 'edit_file', 'write_client_script'],
